Zr.add('./demo2/entrance.js', function (zr, $) {
    ...
    Zr.use(lan_path, function (zr, lan) {
        Zr.use('./base/base.js', './demo2/demo2.js', './ui/ui.js', './demo2/mock.js', function (zr,
            base, demo2, ui, mock) {
            if (Zr.global.env !== 'dist') {
                mock.init(); //线上环境需注释掉
            }
